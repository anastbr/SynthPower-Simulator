...
```{r pressure, echo=FALSE}
simulator = function(total_num_samples,healthy_proportion,num_true_modified,user_specified_n_CpGs,effect_size, user_path, zip_file_name){
...
zip_file_name ="SimMethyl_output"
...
```{r pressure, echo=FALSE}
get_all_combinations = function(total_num_samples_vector,healthy_proportion_vector,num_true_modified_vector,user_specified_n_CpGs_vector,effect_size_vector)
