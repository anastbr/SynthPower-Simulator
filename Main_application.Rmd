...
write.table(truly_different_indices, filename, row.names = FALSE, col.names = FALSE)
...
save_parameters = list(total_num_samples=total_num_samples, healthy_proportion=healthy_proportion,num_true_modified=num_true_modified,user_specified_n_CpGs=user_specified_n_CpGs,effect_size=effect_size)
file_name_parameters = paste0(user_path,"/User Parameters.txt")
write.table(save_parameters,file_name_parameters,row.names = FALSE)
}
```
