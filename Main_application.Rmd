...
gr_2_mean <- calculate_means(gr_2) #?is it necessarily 
...
gr_1_dist_matrix = sample_distribution(gr_1, SDs,0.5*num_samples)
gr_2_dist_matrix = sample_distribution(gr_2, SDs,(1-0.5)*num_samples)
